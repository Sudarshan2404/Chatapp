...
const Room = () => {
  ...
  return (
    <div className="flex justify-center items-centerw-screen h-screen bg-amber-200">
      <div className="flex flex-col w-screen md:w-[50%] h-[80%] md:h-[98%] items-center bg-amber-100 m-2 md:rounded-2xl gap-2 overflow-auto drop-shadow-2xl">
        <h1 className="text-amber-300 text-6xl md:text-8xl g-font mt-20 text-center">
          Simpl-Chat
        </h1>
        <div className="w-full flex flex-col mt-15 justify-center">
          <div className="w-[90%] flex md:justify-between px-25 pb-4 ml-auto mr-auto text-xl md:text-3xl g-font font-semibold border-b-2 border-amber-300">
            {join ? (
              <>
                <button
                  onClick={() => {
          ...
          {join ? (
            <div className=" w-full flex flex-col justify-center items-center mt-10 gap-2">
              <input
                ...
                className="w-[80%] md:w-[60%] bg-[#ffffff] text-xl g-font py-3 px-4 rounded-xl border-2 border-amber-300"
              />
              <input
                name="room"
                ref={usernameref}
            ...
            <div className="w-full flex flex-col justify-center items-center mt-10 gap-2">
              <div className="w-[80%] md:w-[60%] h-15 bg-[#ffffff] text-[16px] md:text-xl g-font py-3 px-4 rounded-xl border-2 border-amber-300">
                {roomCode ? (
                  <h1>{roomCode}</h1>
                ) : (
              ...
              <button
                onClick={genroom}
                className="z-99 bg-amber-300 text-white g-font text-[16px] md:text-3xl py-3 px-4 mt-5 cursor-pointer rounded-xl"
              >
                Genreate Room Code
              </button>
            </div>
